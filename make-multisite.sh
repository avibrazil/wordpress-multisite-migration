...
echo "I'll need password for the OLD database now..."
...
echo "I'll need password for the NEW database now..."
...
echo "I'll need password for the NEW database now, again..."
...
echo "End of multisite conversion and migration."
